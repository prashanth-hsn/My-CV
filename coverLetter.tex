...
% Animator4 has over 25 years legacy codebase and to exploit the modern hardware, 
% we are constantly refactoring code to use multithreaded algorithms, use gpu for 
% general computations etc.
